...
export default class MainRouter {
    ...
    private userRoutes() {
        ...
        this.router.route('/employees/schedule')
            .get(this.employeeScheduleController.readAll)
        this.router.route('/employees/project/:projectId')
            .get(this.employeeController.getEmployeesByProject)
        this.router.route('/employees/schedule/:id')
            .get(this.employeeScheduleController.read)
        this.router.route('/employees/schedule/search')
